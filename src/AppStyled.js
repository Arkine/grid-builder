...
export const PremadeSelect = styled.div`
	position: relative;
	z-index: 10;
...
PremadeSelect.Content = styled.div`
	position: relative;
	z-index: 11;
	max-width: 90%;
...
PremadeSelect.Templates = styled.div`
	display: flex;
	justify-content: center;
	align-items: center;
...
PremadeSelect.Template = styled.div`
	position: relative;
...
PremadeSelect.Overlay = styled.div`
	position: absolute;
	top: 0;
	left: 0;
